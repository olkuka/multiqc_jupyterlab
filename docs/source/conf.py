...
# -*- coding: utf-8 -*-
#
# multiqc_jupyterlab documentation build configuration file
#
...
project = 'multiqc_jupyterlab'
copyright = '2021, Aleksandra Kukawka'
...
_version_py = os.path.join(repo, 'multiqc_jupyterlab', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'multiqc_jupyterlabdoc'
...
latex_documents = [
    (master_doc, 'multiqc_jupyterlab.tex', 'multiqc_jupyterlab Documentation',
     'Aleksandra Kukawka', 'manual'),
]
...
man_pages = [
    (master_doc,
    'multiqc_jupyterlab',
    'multiqc_jupyterlab Documentation',
     [author], 1)
]
